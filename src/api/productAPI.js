...
export const getProducts = async () => {
  try {
    const response = await axios.get('https://my-json-server.typicode.com/geoblo/db-shop/products');
...
export const orderProducts = async (productId, orderCount) => {
  try {
    const response = await axios.post('https://my-json-server.typicode.com/geoblo/db-shop/product-order', { productId, orderCount });
